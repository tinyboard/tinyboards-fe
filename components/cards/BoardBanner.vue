<template>
	<div id="banner" class="flex flex-row space-x-4 items-center p-4 sm:px-12 sm:py-4 bg-gray-200/50 sm:rounded-md sm:shadow-inner-white bg-cover bg-center lights" :style="{ backgroundImage: `url(${board.banner_url || 'https://i.imgur.com/O4ivfHf.jpg'})` }">
        <img :src="board.icon_url || 'https://i.imgur.com/mt4KFVX.png'" class="w-28 h-28 rounded border border-gray-500" />
