<template>
    <div
        class="flex flex-col space-y-4 md:flex-row space-y-0 col-span-full p-4 md:px-8 border-b sm:rounded border-gray-200"
        :class="[
        ...
        <div class="flex flex-row space-x-4 flex-grow">
            ...
            <div class="relative w-24 h-24 md:w-44 md:h-44">
                ...
                <img
                    :src="
                        isEditing
                            ? (imageStore.avatar ?? settings.avatar)
                            : user.avatar
                    "
            ...
            <div class="flex flex-col" :class="{ 'mt-2': !isEditing }">
                ...
                <h1
                    v-else
                    class="font-bold text-xl sm:text-3xl text-white drop-shadow-md"
                >
                ...
                >
                    ...
                    <div
                        v-else
                        class="text-md text-gray-700 user-bio"
                        v-html="user.bioHTML"
                    />
                </div>
                <p
                    v-else
                    class="hidden sm:block mt-2 font-italic text-gray-400 text-md"
                >
        ...
        <div class="flex flex-col space-y-2 flex-grow-0 w-full sm:w-72">
            ...
            >
                ...
                <div
                    v-else
                    class="text-md text-gray-700 user-bio"
                    v-html="user.bio_html"
                />
            </div>
            <p
                v-else
                class="block sm:hidden mt-2 font-italic text-gray-400 text-md"
            >
                This user has no bio. How boring.
            </p>
            ...
            <div
                v-if="isEditing"
                class="w-full flex flex-col space-y-2 text-center"
            >
                <div>
                    <label
                        for="avatar-upload"
                        class="button white w-full cursor-pointer"
                    >
                        Change avatar
                    </label>
                    <input
            ...
            <ul
                v-if="isEditing"
                class="flex flex-row space-x-2 w-full text-center"
            >
                <li class="flex-grow">
                    <button
...
const submitSettings = async () => {
    ...
    if (imageStore.background) {
        ...
        try {
            settings.value.background = await uploadFile(
                background,
                "background",
            );
        } catch (e) {
