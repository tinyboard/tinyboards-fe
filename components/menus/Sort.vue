<template>
    <Menu as="div" id="dropdown-sort" class="dropdown relative z-20">
        <div>
            <MenuButton
                as="div"
                class="group relative flex items-center h-5 text-sm text-gray-500 hover:text-gray-700 dark:hover:text-gray-400"
            >
        ...
        >
            <MenuItems
                class="dropdown-menu absolute w-48 max-h-72 mt-1 bg-white dark:bg-gray-900 rounded-md shadow-xl border dark:border-gray-800 focus:outline-none"
                :class="
                    isLeft
                    ...
                    >
                        <NuxtLink
                            ...
                            :class="[
                                ...
                                'block text-sm px-4 py-2 truncate',
                            ]"
                            @click="
                                sort = item.key;
                                close();
...
// this fixes a hydration mismatch bug: https://github.com/tailwindlabs/headlessui/issues/2913#issuecomment-1922330799
provideUseId(() => useId());
