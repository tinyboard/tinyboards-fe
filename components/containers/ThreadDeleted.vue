<template>
	<div class="relative w-full flex flex-col sm:space-y-6">
		<!-- Alert -->
		<div class="order-2 sm:order-first flex items-center justify-center sm:justify-start mb-2.5 sm:mb-0 px-4 py-2 sm:py-3 text-center sm:text-left text-yellow-900 bg-yellow-100 border-y md:border-x border-yellow-300 md:rounded-md shadow-inner-white">
