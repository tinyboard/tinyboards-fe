    ...
    >
        ...
        >
            ...
            <div v-if="u.isAdmin" class="text-red-600 mt-4">
                ...
                <span class="font-semibold">{{
                    createPermissionString(u.adminLevel)
                }}</span>
            </div>
        </div>
        <!-- Admin Actions -->
        ...
        >
            ...
            <ul class="flex flex-col space-y-2 mt-4">
                <li v-if="requireFullPerms() && u.adminLevel > 0">
                    <button
                        class="flex items-center button white w-full"
                        @click="() => confirmAdmin(false)"
                    >
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            class="w-4 h-4 mr-2"
                ...
                <li v-if="requireFullPerms()">
                    <button
                        class="flex items-center button w-full"
                        :class="[u.isAdmin ? 'red' : 'yellow']"
                        @click="() => confirmAdmin(u.isAdmin)"
                    >
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            class="w-4 h-4 mr-2"
        ...
        >
            ...
            >
                <li
                    v-for="(m, i) in u.moderates"
                    :key="i"
                    class="pt-2 first:pt-0"
                >
                    <NuxtLink :to="`/+${m.board.name}`" class="flex space-x-2">
                        <img
                            loading="lazy"
