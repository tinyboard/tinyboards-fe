    ...
    >
        <div class="flex flex-col space-y-2">
            ...
            <NuxtLink
                ...
                class="flex items-center justify-center button primary"
            >
                <svg
                ...
                <span>{{ isThreadsSection ? 'Create thread' : 'Create post' }}</span>
            </NuxtLink>
        ...
        <div v-if="isMod">
            ...
            <ul class="flex flex-col space-y-2 py-2">
                ...
                <li>
                    <NuxtLink :to="`/b/${board.name}/flairs`" class="flex items-center">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            class="w-4 h-4 mr-2"
                            viewBox="0 0 24 24"
                ...
                >
                    ...
                    >
                        <div class="p-0.5 bg-white border hover:bg-gray-200">
                            <CardsAvatar :src="mod.user.avatar" alt="avatar" size="sm" class="!w-8 !h-8" />
                        </div>
                        <div
