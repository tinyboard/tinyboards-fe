            ...
            <DialogPanel
              ...
              <div class="mt-2">
                <p class="text-sm text-gray-500">
                  {{ options.user.username ?? 'user' }} will {{ options.user.is_admin ? 'have admin privileges revoked' :
              ...
              <div class="mt-4 flex space-x-2 justify-end">
                ...
                <button class="button red" @click="submitAdmin">
                  Yes, {{ options.user.is_admin ? `remove ${options.user.username} as` : `make ${options.user.username}`
                  }} admin
                </button>
              </div>
            </DialogPanel>
