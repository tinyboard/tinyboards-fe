	...
	<main class="flex flex-col pt-12 sm:pt-14">
		...
		<section class="container mx-auto max-w-xl my-48 px-4 sm:px-6">
			<div class="flex flex-col items-center justify-center w-full">
				<!-- Alert -->
				<div class="w-full p-4 bg-white border rounded-md shadow-inner-white">
					<div class="flex items-center">
						<svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-red-600 mr-2" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
						...
						<h1 class="text-lg md:text-xl leading-normal font-bold dark:text-gray-100">
							The user you are looking for is no more.
						</h1>
					</div>
					<hr class="my-2"/>
				...
				<div v-if="isAdmin" class="w-full mt-6 p-4 bg-yellow-100 border border-yellow-300 rounded-md shadow-inner-white">
					<h2 class="text-base font-bold leading-6 text-gray-900">Mod Tools</h2>
					<!-- Deleted -->
					<p v-if="user.is_deleted" class="italic">
						This user was deleted. There are no mod actions available.
					</p>
					<!-- Removed -->
					<ul v-else class="mt-2 pl-4 flex flex-col list-disc">
						<li>
							<button @click="confirmUnban" class="text-red-600 hover:underline">
								Unban {{ user.username }}
							</button>
						</li>
						<li>
