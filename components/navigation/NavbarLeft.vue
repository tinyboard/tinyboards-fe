<template>
	<div id="nav-left" class="fixed top-14 left-0 bg-white border-r border-gray-200 h-screen hidden md:flex flex-col items-center w-20 py-4 md:z-50 overflow-none">
