<template>
	<div class="sm:fixed w-full h-12 bg-gray-100 border-b dark:bg-secondary dark:border-white/10 sm:z-30">
		<div class="mx-auto max-w-8xl h-full flex items-center justify-between px-2.5 sm:px-6">
			<ul class="flex items-center h-full overflow-x-auto scrollbar-hidden box-content p-[1px] m-[-1px]">
				<li class="flex-shrink-0 h-full text-sm leading-6" v-for="link in links" :key="link.name">
