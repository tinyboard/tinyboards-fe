<template>
	<footer id="footer" class="w-full bg-transparent sm:border-t dark:bg-secondary dark:border-white/10">
		<div class="mx-auto max-w-8xl py-5 px-2.5 sm:px-6">
			...
			<p class="footer-attribution mt-2 text-xs text-gray-400 text-center sm:text-left">
