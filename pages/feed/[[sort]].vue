  ...
  <main id="page-feed" class="flex flex-col pt-12 sm:pt-14">
    ...
    >
      <div class="col-span-full flex gap-6">
            ...
            <div class="ml-auto flex space-x-2">
              <button class="ml-auto" @click="preferCardView = true">
                ...
                <svg
                  ...
                  class="w-5 h-5"
                  :class="preferCardView ? 'text-primary' : 'text-gray-500'"
                  viewBox="0 0 24 24"
                  stroke-width="2"
                  stroke="currentColor"
                  fill="none"
              ...
              <button class="ml-auto" @click="preferCardView = false">
                ...
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  class="w-5 h-5"
                  :class="preferCardView ? 'text-gray-500' : 'text-primary'"
                  viewBox="0 0 24 24"
                  stroke-width="2"
                  stroke="currentColor"
                  fill="none"
        ...
        <!-- Sidebar -->
        <component
          :is="route.params.board ? SidebarBoard : Sidebar"
          :board="route.params.board ? dummyBoard : null"
        />
      </div>
    </section>
  </main>
