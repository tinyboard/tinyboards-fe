            ...
            <div class="col-span-full flex gap-6">
                ...
                <div class="w-full">
                    ...
                    <div class="prose prose-sm dark:prose-invert">
                        <h2>Rules</h2>
                        <p>
                            Violating any of these rules can result in a ban.
                            The moderators reserve the right to update these
                            rules at anytime. In general, don't be a jerk.
                        </p>
                        <ol>
                            <li>
                                Be nice to each other - do not bully or harass
                                other members.
                            </li>
