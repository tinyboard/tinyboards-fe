				...
				<div class="flex flex-col space-y-6 divide-y bg-white px-4 py-5 sm:p-6">
					...
					<div class="md:grid md:grid-cols-3 md:gap-6 pt-4 md:pt-6">
						...
						<div class="mt-5 md:col-span-2 md:mt-0 flex flex-col">
								<img v-if="settings.banner" :src="settings.banner" class="w-full h-36 object-cover p-0.5 border bg-white"/>
								<div v-else class="w-full h-36 rounded-md border border-gray-300 border-dashed"></div>
								<div class="mt-5">
