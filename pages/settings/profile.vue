			...
			<div class="space-y-6 bg-white px-4 py-5 sm:p-6">
				...
				<div class="grid grid-cols-3 gap-6">
					<div class="col-span-3 sm:col-span-2">
						<label for="display-name" class="block text-sm font-bold">Display name</label>
				...
				<!-- Biography -->
				<div>
					<label for="biography" class="block text-sm font-bold">Biography</label>
					<div class="mt-1">
						<textarea id="biography" name="biography" rows="3" class="mt-1 block w-full rounded-md border-gray-200 bg-gray-100 shadow-inner-xs focus:bg-white focus:border-primary focus:ring-primary text-base" placeholder="A stranger surfing this World Wide Web." />
					</div>
