        ...
        >
            ...
            <div class="p-4 border-b">
                ...
                <p class="mt-1 text-sm text-gray-600">
                    Long text on the board sidebar. You can use this to write a
                    longer description, add links, set rules, etc. It's all
                    yours.
                </p>
            </div>
            <!-- Form -->
            <form @submit.prevent="onSubmit" @submit="submitSettings()">
                <div class="m-4">
                    ...
                    <div class="flex justify-between">
                        <p
                            class="mt-1 flex justify-end items-center text-sm text-gray-400"
                        >
                            <svg
                        ...
                        <p
                            class="mt-2 text-xs"
                            :class="
                                settings.sidebar?.length > 9950
                                    ? 'text-red-600'
                                    : 'text-gray-500'
                            "
                        >
                            {{ settings.sidebar?.length || 0 }} / 10 000
                        </p>
                    </div>
                </div>
