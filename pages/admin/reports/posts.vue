<template>
	<NuxtLayout name="admin">
		...
		<div class="p-4">
			...
			<p class="mt-1 text-sm text-gray-600">Here are the posts that were reported to you by your users. Reported comments can be found <NuxtLink to="/admin/reports/comments">here</NuxtLink>.</p>
		</div>
		<!-- View Options -->
