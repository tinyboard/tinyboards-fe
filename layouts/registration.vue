<template>
    <div
        ...
        class="relative flex flex-1 flex-col bg-primary dark:bg-gray-950"
    >
        ...
        <main
            class="relative flex flex-1 flex-col overflow-hidden py-8 px-4 sm:px-6 lg:px-8"
        >
            <section
            ...
            >
                <NuxtLink
                    external
                    to="/"
                    class="font-bold text-2xl text-white mb-8"
                >
                    <span>{{ site.name }}</span>
                </NuxtLink>
                <slot />
        ...
        <footer class="relative mx-auto max-w-8xl bg-transparent">
            <div class="py-4 px-4 sm:px-6 md:px-8">
                <ul>
                    <li
                        class="flex items-center space-x-1 -mx-2 text-xs leading-normal"
                    >
                        <NuxtLink
                            external
                            v-for="link in links"
