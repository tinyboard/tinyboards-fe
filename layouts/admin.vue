<template>
	<main id="layout-admin" class="h-full grid grid-cols-1 md:grid-cols-12 pt-12 sm:pt-14">
		...
		<!-- Main Content -->
		<section class="container mx-auto sm:px-4 sm:py-6 md:px-6 overflow-y-auto" :class="showSidebar ? 'col-span-full md:col-span-10 min-[2000px]:col-span-11' : 'col-span-full'">
